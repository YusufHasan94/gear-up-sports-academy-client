...
const Footer = () => {
    return (
        <footer className="footer footer-center p-10 bg-rose-100 text-base-content rounded w-full">
            <div className="grid gap-10 md:gap-0 grid-cols-1 md:grid-cols-3 items-start w-full justify-items-start md:px-10">
                <div className="flex flex-col justify-center md:items-center lg:items-start">
                    <img src={logo} alt="" className="w-24 lg:w-36"/>
                    <h1 className="font-semibold text-start text-4xl md:text-start mb-1">GearUP<br />Sports Academy</h1>
